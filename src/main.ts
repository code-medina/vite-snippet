...
import { seedSnippets } from "./seed/seed.ts";
/* elements dom */
...
const routerOutlet = document.getElementById(
  "cardsContainer",
) as HTMLDivElement;
const filterSelectLang = document.getElementById(
  "filter-language-select",
) as HTMLSelectElement;
const createSelectLang = document.getElementById(
  "language-select",
) as HTMLSelectElement;
